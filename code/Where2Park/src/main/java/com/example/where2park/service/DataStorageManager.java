...
public class DataStorageManager {
    ...
    public static String queryStatistics(String category, String filter) {
        if (category.equals("Κρατήσεις")) {
            switch (filter) {
                case "Ημέρα":
                    return "Στατιστικά Κρατήσεων ανά Ημέρα:\nΔευτέρα: 10\nΤρίτη: 12\nΤετάρτη: 15";
                case "Ώρα":
                    return "Στατιστικά Κρατήσεων ανά Ώρα:\n08:00 - 10:00: 5\n10:00 - 12:00: 8\n12:00 - 14:00: 14";
                case "Μήνας":
                    return "Στατιστικά Κρατήσεων ανά Μήνα:\nΙανουάριος: 50\nΦεβρουάριος: 65\nΜάρτιος: 70";
            }
        } else if (category.equals("Έσοδα")) {
            switch (filter) {
                case "Ημέρα":
                    return "Στατιστικά Εσόδων ανά Ημέρα:\nΔευτέρα: 120€\nΤρίτη: 140€\nΤετάρτη: 160€";
                case "Ώρα":
                    return "Στατιστικά Εσόδων ανά Ώρα:\n08:00 - 10:00: 200€\n10:00 - 12:00: 250€\n12:00 - 14:00: 300€";
                case "Μήνας":
